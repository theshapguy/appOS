...
# cd external/email_listener

# echo "****** Running email_listener build script by changing directory ******"
# # ./build.sh

# echo "****** Running to original directory ******"
# # Change back to the original directory
# cd "$original_dir" 

# # Confirm the directory change (optional)
