defmodule Planet.UserCredentials.UserCredentail do
  use Planet.Schema

  alias Planet.EctoType.CoseKey
  ...
  Query to find all credetials for specific user.
  """
  def query_for_user(query \\ __MODULE__, %Planet.Accounts.User{} = user) do
    query
...
# * creating lib/planet/user_credentials/user_credentail.ex
# * creating priv/repo/migrations/20230714085951_create_user_credentials.exs
# * creating lib/planet/user_credentials.ex
# * injecting lib/planet/user_credentials.ex
# * creating test/planet/user_credentials_test.exs
# * injecting test/planet/user_credentials_test.exs
