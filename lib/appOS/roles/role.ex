defmodule AppOS.Roles.Role do
  use AppOS.Schema
  import Ecto.Changeset
  alias AppOS.ChangesetHelpers
  alias AppOS.Roles.Permissions
  ...
  schema "roles" do
    ...
    # many_to_many :users, AppOS.Accounts.User, join_through: AppOS.Accounts.UserRole
    timestamps()
  end
