defmodule AppOS.Accounts.UserNotifier do
  ...
  defp deliver(recipient, subject, body) do
    email =
      new()
      |> to(recipient)
      |> from({"AppOS", "contact@example.com"})
      |> subject(subject)
      |> text_body(body)
  ...
  def deliver_invite_instructions(member_user, owner_user, url) do
    deliver(member_user.email, "Team Invite Instructions", """

    ==============================

    Hi #{member_user.email}, you have been invited to be a part of the team,

    You can confirm your account by visiting the URL below:

    #{url}

    You have been invited by #{owner_user.email}.
