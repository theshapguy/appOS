defmodule AppOS.Accounts.User do
  use AppOS.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, AppOS.Repo)
  ...
  """
  def valid_password?(%AppOS.Accounts.User{hashed_password: hashed_password}, password)
