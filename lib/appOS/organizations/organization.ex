defmodule AppOS.Organizations.Organization do
  use AppOS.Schema
  import Ecto.Changeset
  alias AppOS.Organizations.OrganizationName
  ...
  schema "organizations" do
    ...
    has_many(:users, AppOS.Accounts.User)

    has_many(:invited_organizations, AppOS.Organizations.Organization,
      foreign_key: :invited_by_id
    )

    # Referred By
    belongs_to(:invited_by, AppOS.Organizations.Organization)
