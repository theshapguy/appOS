defmodule Planet.PaddleClassicHandlerTest do
  ...
  describe "paddle classic webhook handler" do
    setup do
...
#     assert subscription.issued_at == ~U[2024-05-05 01:18:44Z]
#     assert subscription.valid_until == ~U[2024-06-06 00:00:00Z]
#     assert subscription.customer_id == "5"
...
#           "event_time" => "2024-05-05 01:48:54",
#           "fee_refund" => "0.37",
#           "gross_refund" => "0.19",
#           "marketing_consent" => "",
#           "order_id" => "6",
...
#     assert subscription.issued_at == ~U[2024-05-05 01:48:54Z]
#     assert subscription.valid_until == ~U[2024-05-05 01:48:54Z]
#     assert subscription.subscription_id == nil
#     assert subscription.payment_attempt == nil
#     assert subscription.product_id == "default"
...
#           "event_time" => "2024-05-05 01:53:27",
...
#     assert subscription.issued_at == ~U[2024-05-05 01:53:27Z]
#     assert subscription.valid_until == ~U[2024-06-21 00:00:00Z]
